    ...
    <section id="learning" class="learning pt-s">
        <div class="learning__container">
            <h2
                ...
                class="learning__title title _fade-down"
            >
                {{ recruiting_full }}
            </h2>
            <button
                ...
                v-animate-onscroll="'_fade-up'"
                type="button"
                class="learning__button btn _fade-down"
            >
            ...
            <div class="learning__body">
                <template v-for="(grade, key) in grades" :key="key">
                    <router-link
                        :to="{ name: 'grade', params: { slug: grade.slug } }"
                        v-animate-onscroll="'_fade-up'"
                    ...
                    >
                        ...
                        <div
                            class="item-learning__image item-learning__image-ibg"
                        >
                            <picture>
                                <source
                                    :srcset="grade.image.cropped_webp"
                                    type="image/webp" />
                                <img
                                    loading="lazy"
                                    :src="grade.image.cropped"
                                    :alt="grade.title"
                            /></picture>
                        </div>
            ...
            <router-link
                :to="{ name: 'section' }"
                v-animate-onscroll="'_fade-up'"
                class="learning__extra title pt-s _fade-down"
                >+ продленка и секции
            </router-link>
        </div>
    </section>
