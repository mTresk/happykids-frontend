<template>
	<Head>
		...
		<meta name="description" :content="section.title + ' — ' + settings.site_description" />
	</Head>
			...
			<div class="sections-block__container">
				...
				<div class="sections-block__body">
					<div class="sections-block__wrapper">
						...
						<button @click="toggleModal" type="button" class="sections-block__button btn btn_light">Записаться</button>
					</div>

					<div class="sections-block__image sections-block__image-ibg">
						<picture>
							<source :srcset="image_full_webp" type="image/webp" />
